...
sw1_conn_dev = sw1_show_cdp_neighbors_detail.split('--------------------------')
r1_conn_dev = r1_show_cdp_neighbors_detail.split('--------------------------')
r2_conn_dev = r2_show_cdp_neighbors_detail.split('--------------------------')
r3_conn_dev = r3_show_cdp_neighbors_detail.split('--------------------------')
r4_conn_dev = r4_show_cdp_neighbors_detail.split('--------------------------')
r5_conn_dev = r5_show_cdp_neighbors_detail.split('--------------------------')

all_conn_dev = sw1_conn_dev + r1_conn_dev + r2_conn_dev + r3_conn_dev + r4_conn_dev + r5_conn_dev


for device in all_conn_dev:
    hostname = ''
    for line in device.split('\n'):
        ...
        if 'IP address:' in line:
            network_devices[hostname]['ip'] = line.split('IP address: ')[1]
        if 'Platform: ' in line:
            network_devices[hostname]['vendor'] = line.split()[1]
            network_devices[hostname]['model'] = line.split()[2]
            network_devices[hostname]['device_type'] = line.split()[4]
